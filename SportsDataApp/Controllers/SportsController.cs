...
namespace SportsDataApp.Controllers
{
    public class SportsController : Controller
    {
        ...
        public SportsController(SportsDataAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sport != null ? 
                          ...
                          Problem("Entity set 'SportsDataAppContext.Sport'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SportsDataAppContext.Sport'  is null.");
            }
            var sport = await _context.Sport.FindAsync(id);
            if (sport != null)
            {
